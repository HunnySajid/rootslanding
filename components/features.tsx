        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">
              Gain trust, compliance, and credibility with Verifiable LEIs
            </h2>
            <p className="text-xl text-gray-400">
              Securely issue and manage VLEI for your business in minutes.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Elevate Your Business with Secure LEI and VLEI Issuance.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Instant Features</h4>
              <p className="text-lg text-gray-400 text-center">
                Simplify compliance while protecting your data with our secure
                wallet.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Open Standards</h4>
              <p className="text-lg text-gray-400 text-center">
